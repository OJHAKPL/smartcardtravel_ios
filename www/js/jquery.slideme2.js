...
(function ($) {
    ...
    defaultOptions = {
        ...
        itemsForSlide: 1,
        labels: {
            prev: '<span class="img"><img class="responsimg" alt="" src="images/backword.png"></span>',
            next: '<span class="img"><img class="responsimg" alt="" src="images/forward.png"></span>'
        },
        loop: false,
        ...
        $.extend(Plugin.prototype, {
            ...
            createArrows: function(event) {
                ...
                for (key in this.settings.labels) {
                    ...
                    var arrow = $('<a href="javascript:;" class="arrow outline-none" />').addClass(key).html(this.settings.labels[key]).on('click', params, event);
                    arrows[key] = arrow;
					$('.dashboard-link-arrow').append(arrows[key]);
